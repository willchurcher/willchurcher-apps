...
# 02.02 — Function return values (value-returning functions)
...
> **Best practice**
>
> Follow DRY: "Don't repeat yourself". If you need to do something more than once, consider how to modify your code to remove as much redundancy as possible. Variables can be used to store the results of calculations that need to be used more than once (so we don't have to repeat the calculation). Functions can be

---

# 02.03 — Void functions (non-value returning functions)
...
# 02.04 — Introduction to function parameters and arguments
...
`multiply` is called where x = `add(1, 2, 3)

---

# 02.05 — Introduction to local scope
...
In the above program, the function `getValueFromUser()` returns the value stored in local variable `input` back to the caller

---

# 02.06 — Why functions are useful, and how to use them effectively
...
# 02.07 — Forward declarations and definitions
...
# 02.08 — Programs with multiple code files
...
# 02.09 — Naming collisions and an introduction to namespaces
...
# 02.10 — Introduction to the preprocessor
...
# 02.13 — How to design your first programs
...
# 02.x — Chapter 2 summary and quiz
